...
const Home = () => {
  ...
  let getMealTypes = async () => {
    try {
      let url = `https://hunger-buddy-api.vercel.app/api/get-meal-type-list`;
  ...
  let getLocationList = async () => {
    try {
      ...
      setRestaurantList([]);
      let url = `https://hunger-buddy-api.vercel.app/api/get-locations-list`;
      let response = await fetch(url, { method: "GET" });
  ...
  let getRestaurantListByLocationId = async (id, name, city) => {
    try {
      let url = `https://hunger-buddy-api.vercel.app/api/get-restaurant-list-by-location-id/${id}`;
      let response = await fetch(url, { method: "GET" });
